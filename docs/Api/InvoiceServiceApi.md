# Layer7\Openprovider\InvoiceServiceApi
...
```php
listInvoices($limit, $offset, $order, $order_by, $start_creation_date, $end_creation_date): \Layer7\Openprovider\Model\InvoiceListInvoicesResponse
```
...
$apiInstance = new Layer7\Openprovider\Api\InvoiceServiceApi(
...
[**\Layer7\Openprovider\Model\InvoiceListInvoicesResponse**](../Model/InvoiceListInvoicesResponse.md)
