# Layer7\Openprovider\SettingsApi
...
```php
getSettings(): \Layer7\Openprovider\Model\SettingsGetSettingsResponse
```
...
$apiInstance = new Layer7\Openprovider\Api\SettingsApi(
...
[**\Layer7\Openprovider\Model\SettingsGetSettingsResponse**](../Model/SettingsGetSettingsResponse.md)
