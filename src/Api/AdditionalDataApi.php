...
class AdditionalDataApi
{
     ...
     * @param  string|null $operation The operation. (optional)
     ...
     * @return \Layer7\Openprovider\Model\AdditionalDataGetAdditionalDataResponse|\Layer7\Openprovider\Model\ErrorError
     */
    public function getAdditionalData(
        ...
        string $contentType = self::contentTypes['getAdditionalData'][0]
    ): \Layer7\Openprovider\Model\AdditionalDataGetAdditionalDataResponse
    {
        list($response) = $this->getAdditionalDataWithHttpInfo($id, $domain_name, $domain_extension, $operation, $contentType);
        return $response;
    }
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \Layer7\Openprovider\Model\AdditionalDataGetAdditionalDataResponse|\Layer7\Openprovider\Model\ErrorError, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAdditionalDataWithHttpInfo(
        int $id,
        ?string $domain_name = null,
        ?string $domain_extension = null,
        ?string $operation = null,
    ...
    {
        $request = $this->getAdditionalDataRequest($id, $domain_name, $domain_extension, $operation, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\Layer7\Openprovider\Model\AdditionalDataGetAdditionalDataResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Layer7\Openprovider\Model\AdditionalDataGetAdditionalDataResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Layer7\Openprovider\Model\AdditionalDataGetAdditionalDataResponse', []),
            ...
            $returnType = '\Layer7\Openprovider\Model\AdditionalDataGetAdditionalDataResponse';
     ...
     */
    public function getAdditionalDataAsync(
        int $id,
        ?string $domain_name = null,
        ?string $domain_extension = null,
        ?string $operation = null,
    ...
    {
        return $this->getAdditionalDataAsyncWithHttpInfo($id, $domain_name, $domain_extension, $operation, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return PromiseInterface
     */
    public function getAdditionalDataAsyncWithHttpInfo(
        $id,
        $domain_name = null,
