...
class CustomerAdditionalDataApi
{
     ...
     * @return \Layer7\Openprovider\Model\CustomerGetDataResponse|\Layer7\Openprovider\Model\ErrorError
     */
    public function getData(
        int $id,
        ?string $domain_name = null,
        ?string $domain_extension = null,
        string $contentType = self::contentTypes['getData'][0]
    ): \Layer7\Openprovider\Model\CustomerGetDataResponse
    {
        list($response) = $this->getDataWithHttpInfo($id, $domain_name, $domain_extension, $contentType);
        return $response;
    }
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \Layer7\Openprovider\Model\CustomerGetDataResponse|\Layer7\Openprovider\Model\ErrorError, HTTP status code, HTTP response headers (array of strings)
     */
    public function getDataWithHttpInfo(
        int $id,
        ?string $domain_name = null,
        ?string $domain_extension = null,
        string $contentType = self::contentTypes['getData'][0]
    ...
    {
        $request = $this->getDataRequest($id, $domain_name, $domain_extension, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\Layer7\Openprovider\Model\CustomerGetDataResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Layer7\Openprovider\Model\CustomerGetDataResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Layer7\Openprovider\Model\CustomerGetDataResponse', []),
            ...
            $returnType = '\Layer7\Openprovider\Model\CustomerGetDataResponse';
    ...
    {
        return $this->getDataAsyncWithHttpInfo($id, $domain_name, $domain_extension, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return PromiseInterface
     */
    public function getDataAsyncWithHttpInfo(
        $id,
        $domain_name = null,
