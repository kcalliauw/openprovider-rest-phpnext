...
class StatisticsApi
{
     ...
     * @return \Layer7\Openprovider\Model\StatisticsGetStatisticsResponse|\Layer7\Openprovider\Model\ErrorError
     */
    public function getStatistics(
        string $contentType = self::contentTypes['getStatistics'][0]
    ): \Layer7\Openprovider\Model\StatisticsGetStatisticsResponse
    {
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \Layer7\Openprovider\Model\StatisticsGetStatisticsResponse|\Layer7\Openprovider\Model\ErrorError, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\Layer7\Openprovider\Model\StatisticsGetStatisticsResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Layer7\Openprovider\Model\StatisticsGetStatisticsResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Layer7\Openprovider\Model\StatisticsGetStatisticsResponse', []),
            ...
            $returnType = '\Layer7\Openprovider\Model\StatisticsGetStatisticsResponse';
