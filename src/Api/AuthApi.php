...
class AuthApi
{
     ...
     *
     * @param  \Layer7\Openprovider\Model\AuthLoginRequest $body body (required)
     ...
     * @return \Layer7\Openprovider\Model\AuthLoginResponse|\Layer7\Openprovider\Model\ErrorError
     */
    public function login(
        \Layer7\Openprovider\Model\AuthLoginRequest $body,
        string $contentType = self::contentTypes['login'][0]
    ): \Layer7\Openprovider\Model\AuthLoginResponse
    {
     ...
     * Login with username and password
     *
     * @param  \Layer7\Openprovider\Model\AuthLoginRequest $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['login'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \Layer7\Openprovider\Model\AuthLoginResponse|\Layer7\Openprovider\Model\ErrorError, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\Layer7\Openprovider\Model\AuthLoginResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Layer7\Openprovider\Model\AuthLoginResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Layer7\Openprovider\Model\AuthLoginResponse', []),
            ...
            $returnType = '\Layer7\Openprovider\Model\AuthLoginResponse';
