...
class EmailCreateEmailResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'emailCreateEmailResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\EmailCreateEmailResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\EmailCreateEmailResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\EmailCreateEmailResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\EmailCreateEmailResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\EmailCreateEmailResponseData $data): static
    {
        if (is_null($data)) {
