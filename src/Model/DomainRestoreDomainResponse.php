...
class DomainRestoreDomainResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'domainRestoreDomainResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\DomainRestoreDomainResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\DomainRestoreDomainResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\DomainRestoreDomainResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\DomainRestoreDomainResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\DomainRestoreDomainResponseData $data): static
    {
        if (is_null($data)) {
