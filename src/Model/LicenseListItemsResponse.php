...
class LicenseListItemsResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'licenseListItemsResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\LicenseListItemsResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\LicenseListItemsResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\LicenseListItemsResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\LicenseListItemsResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\LicenseListItemsResponseData $data): static
    {
        if (is_null($data)) {
