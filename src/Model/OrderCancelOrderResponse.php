...
class OrderCancelOrderResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'orderCancelOrderResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\OrderCancelOrderResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\OrderCancelOrderResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\OrderCancelOrderResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\OrderCancelOrderResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\OrderCancelOrderResponseData $data): static
    {
        if (is_null($data)) {
