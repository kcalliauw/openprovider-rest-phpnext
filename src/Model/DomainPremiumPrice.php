...
class DomainPremiumPrice implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'domainPremiumPrice';
    ...
    protected static array $openAPITypes = [
        'currency' => 'string',
        'price' => '\Layer7\Openprovider\Model\DomainPrice',
    ...
    */
     ...
     * Gets price
     *
     * @return \Layer7\Openprovider\Model\DomainPrice|null
     */
    public function getPrice(): ?\Layer7\Openprovider\Model\DomainPrice
    {
     ...
     * Sets price
     *
     * @param \Layer7\Openprovider\Model\DomainPrice|null $price price
     *
     * @return $this
     */
    public function setPrice(?\Layer7\Openprovider\Model\DomainPrice $price): static
    {
        if (is_null($price)) {
