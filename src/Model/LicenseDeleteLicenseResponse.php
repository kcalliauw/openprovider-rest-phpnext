...
class LicenseDeleteLicenseResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'licenseDeleteLicenseResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\LicenseDeleteLicenseResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\LicenseDeleteLicenseResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\LicenseDeleteLicenseResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\LicenseDeleteLicenseResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\LicenseDeleteLicenseResponseData $data): static
    {
        if (is_null($data)) {
