...
class NsGroupListGroupsResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ns_groupListGroupsResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\NsGroupListGroupsResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\NsGroupListGroupsResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\NsGroupListGroupsResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\NsGroupListGroupsResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\NsGroupListGroupsResponseData $data): static
    {
        if (is_null($data)) {
