...
class TldListTldsResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'tldListTldsResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\TldListTldsResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\TldListTldsResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\TldListTldsResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\TldListTldsResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\TldListTldsResponseData $data): static
    {
        if (is_null($data)) {
