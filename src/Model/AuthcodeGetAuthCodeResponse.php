...
class AuthcodeGetAuthCodeResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'authcodeGetAuthCodeResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\AuthcodeGetAuthCodeResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\AuthcodeGetAuthCodeResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\AuthcodeGetAuthCodeResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\AuthcodeGetAuthCodeResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\AuthcodeGetAuthCodeResponseData $data): static
    {
        if (is_null($data)) {
