...
class TldGetTldResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'tldGetTldResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\TldTld',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\TldTld|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\TldTld
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\TldTld|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\TldTld $data): static
    {
        if (is_null($data)) {
