...
class CustomerListCustomersResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'customerListCustomersResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\CustomerListCustomersResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\CustomerListCustomersResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\CustomerListCustomersResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\CustomerListCustomersResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\CustomerListCustomersResponseData $data): static
    {
        if (is_null($data)) {
