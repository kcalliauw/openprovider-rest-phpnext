...
class DomainTransferDomainRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'domainTransferDomainRequest';
    ...
    protected static array $openAPITypes = [
        ...
        'additional_data' => '\Layer7\Openprovider\Model\DomainTransferAdditionalData',
        'admin_handle' => 'string',
        'at' => 'string',
        'auth_code' => 'string',
        'autorenew' => 'string',
    ...
    */
     ...
     *
     * @return \Layer7\Openprovider\Model\DomainTransferAdditionalData|null
     */
    public function getAdditionalData(): ?\Layer7\Openprovider\Model\DomainTransferAdditionalData
    {
     ...
     *
     * @param \Layer7\Openprovider\Model\DomainTransferAdditionalData|null $additional_data additional_data
     *
     * @return $this
     */
    public function setAdditionalData(?\Layer7\Openprovider\Model\DomainTransferAdditionalData $additional_data): static
    {
     ...
     * @return $this
     */
    public function setAt(?string $at): static
    {
        if (is_null($at)) {
