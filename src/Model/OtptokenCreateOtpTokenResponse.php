...
class OtptokenCreateOtpTokenResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'otptokenCreateOtpTokenResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\OtptokenCreateOtpTokenResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\OtptokenCreateOtpTokenResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\OtptokenCreateOtpTokenResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\OtptokenCreateOtpTokenResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\OtptokenCreateOtpTokenResponseData $data): static
    {
        if (is_null($data)) {
