...
class OrderListOrdersResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'orderListOrdersResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\OrderListOrdersResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\OrderListOrdersResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\OrderListOrdersResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\OrderListOrdersResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\OrderListOrdersResponseData $data): static
    {
        if (is_null($data)) {
