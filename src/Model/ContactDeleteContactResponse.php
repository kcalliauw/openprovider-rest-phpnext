...
class ContactDeleteContactResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'contactDeleteContactResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\ContactDeleteContactResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\ContactDeleteContactResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\ContactDeleteContactResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\ContactDeleteContactResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\ContactDeleteContactResponseData $data): static
    {
        if (is_null($data)) {
