...
class OrderSslOrder implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'orderSslOrder';
    ...
    protected static array $openAPITypes = [
        'active_date' => 'string',
        'additional_data' => '\Layer7\Openprovider\Model\OrderSslOrderAdditionalData[]',
        ...
        'domain_validation_statuses' => '\Layer7\Openprovider\Model\OrderSslOrderDomainValidationStatuses',
        ...
        'options' => '\Layer7\Openprovider\Model\OrderSslOrderOptions',
        'order_date' => 'string',
    ...
    */
     ...
     *
     * @return \Layer7\Openprovider\Model\OrderSslOrderAdditionalData[]|null
     */
     ...
     *
     * @param \Layer7\Openprovider\Model\OrderSslOrderAdditionalData[]|null $additional_data additional_data
     *
     * @return $this
     */
     ...
     * @return $this
     */
    public function setAdministrativeHandle(?string $administrative_handle): static
    {
     ...
     *
     * @return \Layer7\Openprovider\Model\OrderSslOrderDomainValidationStatuses|null
     */
    public function getDomainValidationStatuses(): ?\Layer7\Openprovider\Model\OrderSslOrderDomainValidationStatuses
    {
     ...
     *
     * @param \Layer7\Openprovider\Model\OrderSslOrderDomainValidationStatuses|null $domain_validation_statuses domain_validation_statuses
     *
     * @return $this
     */
    public function setDomainValidationStatuses(?\Layer7\Openprovider\Model\OrderSslOrderDomainValidationStatuses $domain_validation_statuses): static
    {
     ...
     * @return $this
     */
    public function setEmailApprover(?string $email_approver): static
    {
     ...
     * @return $this
     */
    public function setEmailReissue(?string $email_reissue): static
    {
     ...
     * @return $this
     */
    public function setIntermediateCertificate(?string $intermediate_certificate): static
    {
     ...
     * Gets options
     *
     * @return \Layer7\Openprovider\Model\OrderSslOrderOptions|null
     */
    public function getOptions(): ?\Layer7\Openprovider\Model\OrderSslOrderOptions
    {
     ...
     * Sets options
     *
     * @param \Layer7\Openprovider\Model\OrderSslOrderOptions|null $options options
     *
     * @return $this
     */
    public function setOptions(?\Layer7\Openprovider\Model\OrderSslOrderOptions $options): static
    {
        if (is_null($options)) {
     ...
     * @return $this
     */
    public function setRootCertificate(?string $root_certificate): static
    {
     ...
     * @return $this
     */
    public function setSslinhvaOrderId(?string $sslinhva_order_id): static
    {
     ...
     * @return $this
     */
    public function setTechnicalHandle(?string $technical_handle): static
    {
     ...
     * @return $this
     */
    public function setVendorOrderId(?string $vendor_order_id): static
    {
     ...
     * @return $this
     */
    public function setVendorReferenceId(?string $vendor_reference_id): static
    {
