...
class RecordListZoneRecordsResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'recordListZoneRecordsResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\RecordListZoneRecordsResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\RecordListZoneRecordsResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\RecordListZoneRecordsResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\RecordListZoneRecordsResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\RecordListZoneRecordsResponseData $data): static
    {
        if (is_null($data)) {
