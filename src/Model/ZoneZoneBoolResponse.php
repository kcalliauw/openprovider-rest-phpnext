...
class ZoneZoneBoolResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'zoneZoneBoolResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\ZoneZoneBoolResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\ZoneZoneBoolResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\ZoneZoneBoolResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\ZoneZoneBoolResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\ZoneZoneBoolResponseData $data): static
    {
        if (is_null($data)) {
