...
class NsGroupCreateGroupResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ns_groupCreateGroupResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\NsGroupGroupBoolResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\NsGroupGroupBoolResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\NsGroupGroupBoolResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\NsGroupGroupBoolResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\NsGroupGroupBoolResponseData $data): static
    {
        if (is_null($data)) {
