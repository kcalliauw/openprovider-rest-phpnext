...
class CustomerUpdateCustomerResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'customerUpdateCustomerResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\CustomerUpdateCustomerResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\CustomerUpdateCustomerResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\CustomerUpdateCustomerResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\CustomerUpdateCustomerResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\CustomerUpdateCustomerResponseData $data): static
    {
        if (is_null($data)) {
