...
class CustomerCreateCustomerResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'customerCreateCustomerResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\CustomerCreateCustomerResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\CustomerCreateCustomerResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\CustomerCreateCustomerResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\CustomerCreateCustomerResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\CustomerCreateCustomerResponseData $data): static
    {
        if (is_null($data)) {
