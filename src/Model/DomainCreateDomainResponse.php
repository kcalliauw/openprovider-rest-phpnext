...
class DomainCreateDomainResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'domainCreateDomainResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\DomainCreateDomainResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\DomainCreateDomainResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\DomainCreateDomainResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\DomainCreateDomainResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\DomainCreateDomainResponseData $data): static
    {
        if (is_null($data)) {
