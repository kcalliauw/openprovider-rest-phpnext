...
class NameserverNameserverBoolResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'nameserverNameserverBoolResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\NameserverNameserverBoolResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\NameserverNameserverBoolResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\NameserverNameserverBoolResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\NameserverNameserverBoolResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\NameserverNameserverBoolResponseData $data): static
    {
        if (is_null($data)) {
