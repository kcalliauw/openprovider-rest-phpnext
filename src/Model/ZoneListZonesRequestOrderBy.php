 ...
 */
class ZoneListZonesRequestOrderBy implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'zoneListZonesRequestOrderBy';
