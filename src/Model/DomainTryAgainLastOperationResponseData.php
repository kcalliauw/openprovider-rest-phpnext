 ...
 */
class DomainTryAgainLastOperationResponseData implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'domainTryAgainLastOperationResponseData';
