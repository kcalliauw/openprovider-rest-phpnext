...
class NsGroupGetGroupResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ns_groupGetGroupResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\NsGroupGroup',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\NsGroupGroup|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\NsGroupGroup
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\NsGroupGroup|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\NsGroupGroup $data): static
    {
        if (is_null($data)) {
