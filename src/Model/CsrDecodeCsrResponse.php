...
class CsrDecodeCsrResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'csrDecodeCsrResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\CsrDecodeCsrResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\CsrDecodeCsrResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\CsrDecodeCsrResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\CsrDecodeCsrResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\CsrDecodeCsrResponseData $data): static
    {
        if (is_null($data)) {
