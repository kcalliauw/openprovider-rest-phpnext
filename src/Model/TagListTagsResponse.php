...
class TagListTagsResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'tagListTagsResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\TagListTagsResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\TagListTagsResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\TagListTagsResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\TagListTagsResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\TagListTagsResponseData $data): static
    {
        if (is_null($data)) {
