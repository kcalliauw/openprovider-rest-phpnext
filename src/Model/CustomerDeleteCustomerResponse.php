...
class CustomerDeleteCustomerResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'customerDeleteCustomerResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\CustomerDeleteCustomerResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\CustomerDeleteCustomerResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\CustomerDeleteCustomerResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\CustomerDeleteCustomerResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\CustomerDeleteCustomerResponseData $data): static
    {
        if (is_null($data)) {
