...
class OrderSslOrderDomainValidationStatuses implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'orderSslOrderDomainValidationStatuses';
    ...
    */
     ...
     * @return $this
     */
    public function setCaOperation(?string $ca_operation): static
    {
     ...
     * @return $this
     */
    public function setCaOrderStatus(?string $ca_order_status): static
    {
     ...
     * @return $this
     */
    public function setCaStatus(?string $ca_status): static
    {
