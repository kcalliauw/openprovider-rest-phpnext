...
class AuthcodeResetAuthCodeResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'authcodeResetAuthCodeResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\AuthcodeResetAuthCodeResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\AuthcodeResetAuthCodeResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\AuthcodeResetAuthCodeResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\AuthcodeResetAuthCodeResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\AuthcodeResetAuthCodeResponseData $data): static
    {
        if (is_null($data)) {
