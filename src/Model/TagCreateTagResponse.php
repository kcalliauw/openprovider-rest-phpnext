...
class TagCreateTagResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'tagCreateTagResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\TagCreateTagResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\TagCreateTagResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\TagCreateTagResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\TagCreateTagResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\TagCreateTagResponseData $data): static
    {
        if (is_null($data)) {
