...
class CustomerGetCustomerResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'customerGetCustomerResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\CustomerGetCustomerResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\CustomerGetCustomerResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\CustomerGetCustomerResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\CustomerGetCustomerResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\CustomerGetCustomerResponseData $data): static
    {
        if (is_null($data)) {
