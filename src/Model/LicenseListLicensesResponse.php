...
class LicenseListLicensesResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'licenseListLicensesResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\LicenseListLicensesResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\LicenseListLicensesResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\LicenseListLicensesResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\LicenseListLicensesResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\LicenseListLicensesResponseData $data): static
    {
        if (is_null($data)) {
