...
class EmailListEmailsResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'emailListEmailsResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\EmailListEmailsResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\EmailListEmailsResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\EmailListEmailsResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\EmailListEmailsResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\EmailListEmailsResponseData $data): static
    {
        if (is_null($data)) {
