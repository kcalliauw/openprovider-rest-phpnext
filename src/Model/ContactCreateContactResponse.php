...
class ContactCreateContactResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'contactCreateContactResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\ContactCreateContactResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\ContactCreateContactResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\ContactCreateContactResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\ContactCreateContactResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\ContactCreateContactResponseData $data): static
    {
        if (is_null($data)) {
