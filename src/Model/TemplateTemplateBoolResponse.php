...
class TemplateTemplateBoolResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'templateTemplateBoolResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\TemplateTemplateBoolResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\TemplateTemplateBoolResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\TemplateTemplateBoolResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\TemplateTemplateBoolResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\TemplateTemplateBoolResponseData $data): static
    {
        if (is_null($data)) {
