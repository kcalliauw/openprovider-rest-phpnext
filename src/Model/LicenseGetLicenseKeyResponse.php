...
class LicenseGetLicenseKeyResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'licenseGetLicenseKeyResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\LicenseLicenseKey',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\LicenseLicenseKey|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\LicenseLicenseKey
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\LicenseLicenseKey|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\LicenseLicenseKey $data): static
    {
        if (is_null($data)) {
