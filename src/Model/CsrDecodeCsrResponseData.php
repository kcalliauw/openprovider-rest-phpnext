...
class CsrDecodeCsrResponseData implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'csrDecodeCsrResponseData';
    ...
    protected static array $openAPITypes = [
        ...
        'public_key' => '\Layer7\Openprovider\Model\CsrCsrPublicKey',
        'signature_hash_algorithm' => 'string',
        'subject' => '\Layer7\Openprovider\Model\CsrCsrSubject',
    ...
    */
     ...
     * @return $this
     */
    public function setDomainNamesCount(?int $domain_names_count): static
    {
     ...
     * Gets public_key
     *
     * @return \Layer7\Openprovider\Model\CsrCsrPublicKey|null
     */
    public function getPublicKey(): ?\Layer7\Openprovider\Model\CsrCsrPublicKey
    {
     ...
     * Sets public_key
     *
     * @param \Layer7\Openprovider\Model\CsrCsrPublicKey|null $public_key public_key
     *
     * @return $this
     */
    public function setPublicKey(?\Layer7\Openprovider\Model\CsrCsrPublicKey $public_key): static
    {
     ...
     * Gets subject
     *
     * @return \Layer7\Openprovider\Model\CsrCsrSubject|null
     */
    public function getSubject(): ?\Layer7\Openprovider\Model\CsrCsrSubject
    {
     ...
     * Sets subject
     *
     * @param \Layer7\Openprovider\Model\CsrCsrSubject|null $subject subject
     *
     * @return $this
     */
    public function setSubject(?\Layer7\Openprovider\Model\CsrCsrSubject $subject): static
    {
        if (is_null($subject)) {
