...
class AuthLoginResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'authLoginResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\AuthLoginResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\AuthLoginResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\AuthLoginResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\AuthLoginResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\AuthLoginResponseData $data): static
    {
        if (is_null($data)) {
     ...
     * Sets desc
     *
     * @param string|null $desc The desc
     *
     * @return $this
     */
     ...
     * Sets warnings
     *
     * @param \Layer7\Openprovider\Model\ErrorWarning[]|null $warnings The warnings
     *
     * @return $this
     */
