...
class PriceGetPriceResponseData implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'priceGetPriceResponseData';
    ...
    protected static array $openAPITypes = [
        'is_premium' => 'bool',
        'price' => '\Layer7\Openprovider\Model\PricePrices'
    ];
    ...
    */
     ...
     * Gets price
     *
     * @return \Layer7\Openprovider\Model\PricePrices|null
     */
    public function getPrice(): ?\Layer7\Openprovider\Model\PricePrices
    {
     ...
     * Sets price
     *
     * @param \Layer7\Openprovider\Model\PricePrices|null $price price
     *
     * @return $this
     */
    public function setPrice(?\Layer7\Openprovider\Model\PricePrices $price): static
    {
        if (is_null($price)) {
