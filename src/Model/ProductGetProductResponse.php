...
class ProductGetProductResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'productGetProductResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\ProductSslProduct',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\ProductSslProduct|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\ProductSslProduct
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\ProductSslProduct|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\ProductSslProduct $data): static
    {
        if (is_null($data)) {
