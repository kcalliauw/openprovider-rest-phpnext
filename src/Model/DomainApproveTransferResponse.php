 ...
 */
class DomainApproveTransferResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'domainApproveTransferResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\DomainApproveTransferResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\DomainApproveTransferResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\DomainApproveTransferResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\DomainApproveTransferResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\DomainApproveTransferResponseData $data): static
    {
        if (is_null($data)) {
