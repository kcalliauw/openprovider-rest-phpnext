...
class TemplateListTemplatesResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'templateListTemplatesResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\TemplateListTemplatesResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\TemplateListTemplatesResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\TemplateListTemplatesResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\TemplateListTemplatesResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\TemplateListTemplatesResponseData $data): static
    {
        if (is_null($data)) {
