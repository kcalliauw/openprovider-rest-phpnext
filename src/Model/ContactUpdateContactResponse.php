...
class ContactUpdateContactResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'contactUpdateContactResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\ContactUpdateContactResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\ContactUpdateContactResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\ContactUpdateContactResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\ContactUpdateContactResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\ContactUpdateContactResponseData $data): static
    {
        if (is_null($data)) {
