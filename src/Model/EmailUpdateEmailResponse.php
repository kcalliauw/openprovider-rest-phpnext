...
class EmailUpdateEmailResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'emailUpdateEmailResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\EmailUpdateEmailResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\EmailUpdateEmailResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\EmailUpdateEmailResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\EmailUpdateEmailResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\EmailUpdateEmailResponseData $data): static
    {
        if (is_null($data)) {
