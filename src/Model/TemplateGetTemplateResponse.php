...
class TemplateGetTemplateResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'templateGetTemplateResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\TemplateTemplate',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\TemplateTemplate|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\TemplateTemplate
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\TemplateTemplate|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\TemplateTemplate $data): static
    {
        if (is_null($data)) {
