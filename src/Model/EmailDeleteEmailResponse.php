...
class EmailDeleteEmailResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'emailDeleteEmailResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\EmailDeleteEmailResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\EmailDeleteEmailResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\EmailDeleteEmailResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\EmailDeleteEmailResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\EmailDeleteEmailResponseData $data): static
    {
        if (is_null($data)) {
