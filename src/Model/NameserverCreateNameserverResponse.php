...
class NameserverCreateNameserverResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'nameserverCreateNameserverResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\NameserverNameserver',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\NameserverNameserver|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\NameserverNameserver
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\NameserverNameserver|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\NameserverNameserver $data): static
    {
        if (is_null($data)) {
