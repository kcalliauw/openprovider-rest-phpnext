...
class DomainTradeDomainResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'domainTradeDomainResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\DomainTradeDomainResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\DomainTradeDomainResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\DomainTradeDomainResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\DomainTradeDomainResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\DomainTradeDomainResponseData $data): static
    {
        if (is_null($data)) {
