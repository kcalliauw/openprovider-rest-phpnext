...
class ContactListContactsResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'contactListContactsResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\ContactListContactsResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\ContactListContactsResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\ContactListContactsResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\ContactListContactsResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\ContactListContactsResponseData $data): static
    {
        if (is_null($data)) {
