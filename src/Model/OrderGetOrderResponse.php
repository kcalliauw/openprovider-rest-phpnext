...
class OrderGetOrderResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'orderGetOrderResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\OrderSslOrder',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\OrderSslOrder|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\OrderSslOrder
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\OrderSslOrder|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\OrderSslOrder $data): static
    {
        if (is_null($data)) {
