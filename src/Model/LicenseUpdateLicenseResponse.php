...
class LicenseUpdateLicenseResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'licenseUpdateLicenseResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\LicenseUpdateLicenseResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\LicenseUpdateLicenseResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\LicenseUpdateLicenseResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\LicenseUpdateLicenseResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\LicenseUpdateLicenseResponseData $data): static
    {
        if (is_null($data)) {
