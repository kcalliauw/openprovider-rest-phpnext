...
class CsrCreateCsrResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'csrCreateCsrResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\CsrCreateCsrResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\CsrCreateCsrResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\CsrCreateCsrResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\CsrCreateCsrResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\CsrCreateCsrResponseData $data): static
    {
        if (is_null($data)) {
