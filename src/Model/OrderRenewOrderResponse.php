...
class OrderRenewOrderResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'orderRenewOrderResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\OrderRenewOrderResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\OrderRenewOrderResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\OrderRenewOrderResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\OrderRenewOrderResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\OrderRenewOrderResponseData $data): static
    {
        if (is_null($data)) {
