...
class SettingsGetSettingsResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'settingsGetSettingsResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\SettingsGetSettingsResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\SettingsGetSettingsResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\SettingsGetSettingsResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\SettingsGetSettingsResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\SettingsGetSettingsResponseData $data): static
    {
        if (is_null($data)) {
