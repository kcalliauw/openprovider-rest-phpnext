...
class DomainUpdateDomainResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'domainUpdateDomainResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\DomainUpdateDomainResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\DomainUpdateDomainResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\DomainUpdateDomainResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\DomainUpdateDomainResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\DomainUpdateDomainResponseData $data): static
    {
        if (is_null($data)) {
