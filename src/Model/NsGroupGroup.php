...
class NsGroupGroup implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ns_groupGroup';
    ...
    */
     ...
     * @return $this
     */
    public function setDomainCount(?int $domain_count): static
    {
     ...
     * @return $this
     */
    public function setNsCount(?int $ns_count): static
    {
        if (is_null($ns_count)) {
