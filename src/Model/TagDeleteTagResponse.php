...
class TagDeleteTagResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'tagDeleteTagResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\TagDeleteTagResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\TagDeleteTagResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\TagDeleteTagResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\TagDeleteTagResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\TagDeleteTagResponseData $data): static
    {
        if (is_null($data)) {
