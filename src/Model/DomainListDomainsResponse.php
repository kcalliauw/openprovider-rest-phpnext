...
class DomainListDomainsResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'domainListDomainsResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\DomainListDomainsResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\DomainListDomainsResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\DomainListDomainsResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\DomainListDomainsResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\DomainListDomainsResponseData $data): static
    {
        if (is_null($data)) {
