...
class OrderCreateOrderResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'orderCreateOrderResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\OrderCreateOrderResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\OrderCreateOrderResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\OrderCreateOrderResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\OrderCreateOrderResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\OrderCreateOrderResponseData $data): static
    {
        if (is_null($data)) {
