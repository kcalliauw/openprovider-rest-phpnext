...
class DomainGetDomainResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'domainGetDomainResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\DomainGetDomainResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\DomainGetDomainResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\DomainGetDomainResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\DomainGetDomainResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\DomainGetDomainResponseData $data): static
    {
        if (is_null($data)) {
