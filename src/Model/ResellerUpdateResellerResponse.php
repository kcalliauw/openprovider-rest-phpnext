...
class ResellerUpdateResellerResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'resellerUpdateResellerResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\ResellerUpdateResellerResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\ResellerUpdateResellerResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\ResellerUpdateResellerResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\ResellerUpdateResellerResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\ResellerUpdateResellerResponseData $data): static
    {
        if (is_null($data)) {
