 ...
 */
class DomainClientTransferProhibited implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'domainClientTransferProhibited';
