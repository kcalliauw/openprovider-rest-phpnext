 ...
 */
class DomainTryAgainLastOperationResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'domainTryAgainLastOperationResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\DomainTryAgainLastOperationResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\DomainTryAgainLastOperationResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\DomainTryAgainLastOperationResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\DomainTryAgainLastOperationResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\DomainTryAgainLastOperationResponseData $data): static
    {
        if (is_null($data)) {
