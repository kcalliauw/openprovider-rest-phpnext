...
class PaymentListPaymentsResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'paymentListPaymentsResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\PaymentListPaymentsResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\PaymentListPaymentsResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\PaymentListPaymentsResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\PaymentListPaymentsResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\PaymentListPaymentsResponseData $data): static
    {
        if (is_null($data)) {
