...
class ProductListProductsResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'productListProductsResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\ProductListProductsResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\ProductListProductsResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\ProductListProductsResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\ProductListProductsResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\ProductListProductsResponseData $data): static
    {
        if (is_null($data)) {
