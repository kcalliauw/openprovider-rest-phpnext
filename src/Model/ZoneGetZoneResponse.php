...
class ZoneGetZoneResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'zoneGetZoneResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\ZoneZone',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\ZoneZone|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\ZoneZone
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\ZoneZone|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\ZoneZone $data): static
    {
        if (is_null($data)) {
