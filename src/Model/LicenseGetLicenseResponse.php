...
class LicenseGetLicenseResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'licenseGetLicenseResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\LicenseExtendedLicense',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     */
    public function getData(): ?\Layer7\Openprovider\Model\LicenseExtendedLicense
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\LicenseExtendedLicense|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\LicenseExtendedLicense $data): static
    {
        if (is_null($data)) {
