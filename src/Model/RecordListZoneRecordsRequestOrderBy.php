 ...
 */
class RecordListZoneRecordsRequestOrderBy implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'recordListZoneRecordsRequestOrderBy';
