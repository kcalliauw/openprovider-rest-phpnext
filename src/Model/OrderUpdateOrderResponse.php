...
class OrderUpdateOrderResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'orderUpdateOrderResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\OrderUpdateOrderResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\OrderUpdateOrderResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\OrderUpdateOrderResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\OrderUpdateOrderResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\OrderUpdateOrderResponseData $data): static
    {
        if (is_null($data)) {
