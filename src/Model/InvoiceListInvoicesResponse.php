...
class InvoiceListInvoicesResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'invoiceListInvoicesResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\InvoiceListInvoicesResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\InvoiceListInvoicesResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\InvoiceListInvoicesResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\InvoiceListInvoicesResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\InvoiceListInvoicesResponseData $data): static
    {
        if (is_null($data)) {
