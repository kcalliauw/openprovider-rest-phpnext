...
class StatisticsGetStatisticsResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'statisticsGetStatisticsResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\StatisticsGetStatisticsResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\StatisticsGetStatisticsResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\StatisticsGetStatisticsResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\StatisticsGetStatisticsResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\StatisticsGetStatisticsResponseData $data): static
    {
        if (is_null($data)) {
