...
class OrderReissueOrderResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'orderReissueOrderResponse';
    ...
    protected static array $openAPITypes = [
        'code' => 'int',
        'data' => '\Layer7\Openprovider\Model\OrderReissueOrderResponseData',
        'desc' => 'string',
        'maintenance' => 'bool',
    ...
    */
     ...
     * Gets data
     *
     * @return \Layer7\Openprovider\Model\OrderReissueOrderResponseData|null
     */
    public function getData(): ?\Layer7\Openprovider\Model\OrderReissueOrderResponseData
    {
     ...
     * Sets data
     *
     * @param \Layer7\Openprovider\Model\OrderReissueOrderResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Layer7\Openprovider\Model\OrderReissueOrderResponseData $data): static
    {
        if (is_null($data)) {
